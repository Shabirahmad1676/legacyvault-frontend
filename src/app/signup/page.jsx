...
import { Shield, CheckCircle2, AlertCircle, ArrowRight, Mail, Lock, Eye, EyeOff } from "lucide-react";
  ...
  return (
    <main className="relative min-h-screen bg-[#050505] text-zinc-100 selection:bg-emerald-500/30 flex flex-col lg:flex-row overflow-hidden">
      ...
      >
        <motion.div variants={containerVariants} initial="hidden" animate="visible">
          ...
          <motion.div className="mt-24 max-w-sm" variants={itemVariants}>
            ...
            <div className="mt-12 space-y-4">
              {[
                { title: "Private Encrypted Vault", desc: "Zero-knowledge encryption for sensitive records." },
                { title: "Quorum Governance", desc: "Emergency recovery requires trusted trustee consensus." },
              ].map((item, i) => (
                <motion.div
                  key={i}
        ...
        >
          Cryptographically sovereign • End-to-end encrypted
        </motion.div>
      </motion.section>
        ...
        >
          ...
          <motion.div className="mb-10 text-center lg:text-left" variants={itemVariants} initial="hidden" animate="visible" transition={{ delay: 0.3 }}>
            ...
            <p className="mt-2.5 text-sm text-zinc-400">
              Initialize your private legacy plan.
            </p>
          </motion.div>
              ...
              {({ values, errors, touched, handleChange, handleBlur, handleSubmit, isSubmitting }) => (
                ...
                >
                  ...
                  {apiError && (
                    <motion.div
                      role="alert"
                      className="flex gap-3 rounded-lg border border-red-500/30 bg-red-500/15 p-4 text-sm text-red-300 backdrop-blur-md"
                  ...
                  <motion.div className="pt-6" variants={itemVariants}>
                    ...
                    >
                      {isSubmitting ? (
                        ...
                        <>
                          <span>Deploy Vault Instance</span>
                  ...
                  <motion.p className="pt-6 text-center text-sm text-zinc-500" variants={itemVariants}>
                    Already registered?{" "}
                    <Link href="/login" className="font-medium text-zinc-300 transition-colors hover:text-emerald-400">
                      Sign in
                    </Link>
                  </motion.p>
                </motion.form>
